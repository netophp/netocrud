        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-8 col-lg-offset-2">
                    <form action="mmedi1.php" method="post" novalidate>
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>Nombre del medicamento: </label>
                                <input type="text" class="form-control" placeholder="Nombre medicamento" id="name" required data-validation-required-message="Ingrese nombre del medicamento." name="name1">
