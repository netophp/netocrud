    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">Pharmacy</a>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <?php
                    if ($op==1){
						echo "<h2>Se Agrego un Medicamento</h2>";
                    }
					else if ($op==2){
						echo "<h2>Se Modifico un Medicamento</h2>";
                    }
					else if ($op==3){
						echo "<h2>Se Elimino un Medicamento</h2>";
                    }
					?>
...
<center><img src="img/pharma.png" ></center>                   
                </div>
            </div>
        </div>
    </section>
